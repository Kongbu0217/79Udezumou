            ...
            <div class="col-md-3 mb-4"> <!-- カードを横4つに -->
                <div class="card h-100"> <!-- 高さ統一 -->
                    <div class="card-body text-center" id="card">    
                        <!-- チェックボックス　MIO -->
                        <label>
                            <input type="checkbox" id="checkbox"> 背景色を変える
                        </label>
                        <script>
                            // チェックボックスとカードの参照を取得
                    ...
                    <div class="image-container mb-3">
                        <!-- 三項演算子 -->
                    <img src="{{ $post->path ? asset('assets/' . $post->path) : 'https://dummyimage.com/150x150/e314e3/ffffff.png' }}" class="img-fluid" alt="投稿画像">
                    </div>
